        ...
        <>
            <Box component="main" sx={{
                ...
                <Paper elevation={4} sx={{
                    ...
                    maxWidth: 420,
                    width: '92vw',
                    boxShadow: '0 4px 24px rgba(80,100,200,0.08)',
                    position: 'relative',
                    overflow: 'visible'
                }}>
                    <Box sx={{display: 'flex', flexDirection: 'column', alignItems: 'center', mb: 2}}>
                        <Avatar sx={{
                            ...
                            height: 64,
                            mb: 1,
                            boxShadow: '0 2px 8px #b3b3b3'
                        }}>
                            <WorkspacePremiumRoundedIcon sx={{fontSize: 38, color: '#fff'}}/>
                        </Avatar>
                        <Typography variant="h5" fontWeight={900}
                                    sx={{color: theme.palette.secondary.main, mb: 0.5, letterSpacing: -1}}>
                            워크스페이스 생성
                        </Typography>
                    ...
                    <form onSubmit={handleSubmit} autoComplete="off">
                        ...
                        />
                        <TextField
                            label={<span style={{fontWeight: 700}}>설명 <span
                                style={{color: '#aaa', fontWeight: 400}}>(선택)</span></span>}
